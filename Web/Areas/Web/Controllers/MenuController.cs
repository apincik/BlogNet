...
namespace Web.Areas.Cms.Controllers
{
    ...
    public class MenuController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var items = projectId != null ? await _menuItemService.ListAllByProjectId((int)projectId) : new List<MenuItem>();
        ...
        {
            await _menuItemService.DeleteAsyncById(id);
        ...
        public async Task<IActionResult> Create()
        {
            ...
            {
                ProjectId = projectId,
                Items = await _menuItemService.ListAllByProjectId(projectId)
            };
        ...
        public async Task<IActionResult> Create(MenuItemCreateViewModel model)
        {
            if (!ModelState.IsValid)
            {
                ...
                model.Items = await _menuItemService.ListAllByProjectId(projectId);
        ...
        {
            var variable = await _menuItemService.Get((int)id);
            var model = _mapper.Map<MenuItemUpdateViewModel>(variable);
            model.Items = await _menuItemService.ListAllByProjectId(model.ProjectId);
